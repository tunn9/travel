...
function _check_requirements() {
    ...
    if(version_compare( $required_php_version, $php_version, '>')) {
        _error("Installation Error", sprintf('<p class="text-center">Your server is running PHP version %1$s but PHPTravels %2$s requires at least %3$s.</p>', $php_version, '6.1', $required_php_version));
    }
    /* check mysql version */
...
// Function to write the config file
    ...
    function sendEmail($postData){
        ...
        $message = '<table width="100%" cellspacing="0" cellpadding="0" bgcolor="#e3e4e6">
<tbody><tr>
<td>
...
Your new PHPTRAVELS installation is completed! Below you will find instructions on how to access to your website.
</td>
</tr>
</tbody></table>
</td>
...
<tbody><tr>
<td width="99">
<img src="http://phptravels.net/uploads/global/favicon.png" border="0" style="vertical-align:top;font:22px/26px Arial,Helvetica,sans-serif;color:#fff" alt="WordPress" width="99" height="101" class="CToWUd">
</td>
<td width="20">&nbsp;</td>
...
We recommend to read our documentation and start configuration of your website from general settings to payment gateways to data management!
</td>
</tr>
<tr>
...
<a href="http://phptravels.com/documentation/" style="text-decoration:none;color:#fff;display:block;padding:13px 10px" target="_blank" >Documentation</a>
</td>
</tr>
</tbody></table>
</td>
...
<tr>
<td align="right">
<a href="http://www.phptravels.com" style="text-decoration:none" target="_blank" border="0" style="vertical-align:top" alt="PHPTRAVELS" width="207" height="24" class="CToWUd"><img src="http://phptravels.com/assets/img/logo.png" alt="php travels" /></a>
</td>
</tr>
</tbody></table>
</td>
...
<tr>
<td><div style="white-space:nowrap;font:15px/2px courier;color:#e3e4e6">- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -</div></td>
</tr>
</tbody></table>';
