<section  id="ROOMS">
    ...
    <form style="margin-bottom: 3px; background-color: #fff; border: 0px solid transparent; border-radius: 0px;" class="panel" action="" method="GET">
      <div class="rooms-update" style="margin-top:0px;margin-bottom:0px">
        ...
        <div class="col-md-3">
            ...
            <div class="book">
              <span <?php if(!empty($loggedin)){ ?> onclick="booknow()" <?php }else{ ?> data-toggle="modal" data-target="#book<?php echo $room['rateCode'];?>" <?php } ?> class="btn btn-action btn-block btn-lg"><?php echo trans('0142');?></span>
            </div>
            <div class="clearfix"></div>
