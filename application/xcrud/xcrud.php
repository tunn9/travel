...
class Xcrud
{
    ...
    protected function __construct()
    {
        ...
        $this->chkboxClass = Xcrud_config::$singleCheckboxClass;
            ...
            '&uarr; ', 'desc' => '&darr; '))
    {
        ...
        $out .= $this->open_tag($item)."<input class=".Xcrud_config::$selectAllClass." type='checkbox' value='' id=".Xcrud_config::$selectAllId." > ".$this->close_tag($item);
        if ($this->is_numbers)
        {
    ...
    protected function render_grid_body($row_tag = array('tag' => 'tr'), $item = array('tag' => 'td'))
    {
        ...
        if ($this->result_list)
        {
            foreach ($this->result_list as $key => $row)
            {
                ...
                $out .= $this->open_tag($item)."<input class=".Xcrud_config::$singleCheckboxClass." type='checkbox' value=".$row['primary_key'].">".$this->close_tag($item);
                if ($this->is_numbers)
                {
    ...
    protected function delete_button($label = "Delete",$class = '', $icon = '')
    {

            return $this->render_button($label, 'delete','', $class, $icon);
