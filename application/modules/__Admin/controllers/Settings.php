...
class Settings extends MX_Controller {
		...
		public function app_settings() {
				...
				$this->data['page_title'] = 'Cấu hình ứng dụng';
...
//  $this->data['msg'] =  $this->Settings_model->pt_install_theme();
		...
		public function sliders($trans = null, $id = null, $lang = null) {
        	...
        	if (!empty ($trans) && !empty ($id)) {
                        ...
                        $xcrud->columns('slide_image,slide_title_text,slide_desc_text,slide_status,slide_order');
                        $xcrud->fields('slide_image,slide_title_text,slide_desc_text, slide_status'); // fields in details
						...
						$xcrud->label('slide_image','Ảnh')->label('slide_title_text','Tiêu đề')->label('slide_desc_text','Miêu tả')->label('slide_status','Trạng thái hoạt động')->label('slide_order','Vị trí');

                        $xcrud->multiDelUrl = base_url().'admin/ajaxcalls/delMultipleSlides';
        
                        $this->data['content'] = $xcrud->render();
                        $this->data['page_title'] = 'Cấu hình ảnh nền';
                        $this->data['main_content'] = 'temp_view';
                        $this->data['header_title'] = 'Cấu hình ảnh nền';
                        $this->load->view('template', $this->data);
