<script>
  ...
  if(status == "1"){
    ...
    $("#offmsg").prop("readonly",true);
            ...
            <div class="panel-title"><i class="fa fa-cogs"></i><?php echo trans('0148');?></div>
            <div class="panel-tools pull-right">
            <ul class="nav nav-tabs">
            <li class="active"><a href="#GENERAL" data-toggle="tab"><?php echo trans('03');?></a></li>
            ...
            <li class=""><a href="#CONTACT" data-toggle="tab"><?php echo trans('045');?></a></li>
            <!-- <li class=""><a href="#SERVER" data-toggle="tab">Server Information</a></li> -->
            </ul>
            </div>
            </div>
        ...
        <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
          <div class="well well-sm">
            <div class="row form-group">
              <label  class="col-md-2 control-label text-left"><?php echo trans('0149');?></label>
              <div class="col-md-4">
                <div class="input-group input-xs">
                  <input type="file" class="btn btn-default" id="hlogo" name="hlogo">
                  <span class="help-block"><?php echo trans('0147');?></span>
                </div>
              </div>
              <div class="col-md-4">
          ...
          <div class="row form-group">
            <label  class="col-md-2 control-label text-left"><?php echo trans('0150');?></label>
            <div class="col-md-4">
              <input name="site_title" type="text"  placeholder="<?php echo trans('0150');?>" class="form-control" value="<?php echo $settings[0]->site_title;?>" />
            </div>
          </div>
          <div class="row form-group">
          ...
          <!-- <div class="row form-group">
            <label  class="col-md-2 control-label text-left">Restrict Website </label>
            <div class="col-md-2">
              <select name="restrict" class="form-control">
                <option value="No" <?php makeSelected('No',$settings[0]->restrict_website); ?> > No </option>
                <option value="Yes" <?php makeSelected('Yes',$settings[0]->restrict_website); ?> > Yes </option>
              </select>
            </div>
            <small><strong> If selected 'Yes' then only registered users can access your website.<br> Website access to any page will be blocked for all other users.</strong></small>
          </div> -->
          <!-- <div class="row form-group">
          ...
          <!-- <div class="row form-group">
            <label  class="col-md-2 control-label text-left">Users Reg. Approval</label>
            <div class="col-md-2">
          ...
          <div class="row form-group">
            <label  class="col-md-2 control-label text-left"><?php echo trans('0151');?></label>
            <div class="col-md-4">
              <input name="slogan" type="text" placeholder="Slogan" class="form-control" value="<?php echo $settings[0]->home_title;?>" />
            </div>
          </div>
          <div class="row form-group">
            <label  class="col-md-2 control-label text-left"><?php echo trans('0114');?></label>
            <div class="col-md-8">
              <input class="form-control" type="text" placeholder="<?php echo trans('0114');?>" name="keywords" value="<?php echo $settings[0]->keywords;?>" >
            </div>
          </div>
          <div class="row form-group">
            <label  class="col-md-2 control-label text-left"><?php echo trans('0155');?></label>
            <div class="col-md-8">
              <textarea class="form-control" rows="2" placeholder="<?php echo trans('0155');?>" name="meta_description" ><?php echo $settings[0]->meta_description;?></textarea>
            </div>
          </div>
          <!-- <div class="row form-group">
          ...
          <div class="row form-group">
            ...
            <!-- <label class="col-md-2"><a class="btn btn-success btn-block" target="_blank" href="<?php base_url(); ?>admin/settings/downloadSitemap">Download Sitemap</a></label>
            <label class="col-md-2"><a class="btn btn-primary btn-block" target="_blank" href="<?php base_url(); ?>sitemap.xml">Show Sitemap</a></label> -->
            <label class="col-md-2"><a class="btn btn-success btn-block" target="_blank" >Download Sitemap</a></label>
            <label class="col-md-2"><a class="btn btn-primary btn-block" target="_blank" >Show Sitemap</a></label>
          </div>
          <!-- <div class="row form-group">
      ...
      <input name="mobile[apiKey]" type="text"  placeholder="API Key" class="form-control" value="<?php echo $mobileSettings->apiKey;?>" />
        ...
        <div class="tab-pane wow fadeIn animated in" id="CONTACT">
          <div class="panel-body">
            ...
            <div class="row form-group">
              <label class="col-md-2 control-label text-left"><?php echo trans('0128');?></label>
              <div class="col-md-6">
