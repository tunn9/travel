  ...
  <form method="post" action="" enctype="multipart/form-data" >
    ...
    <div class="panel panel-default">
      <ul class="nav nav-tabs nav-justified" role="tablist">
        <li class="active"><a href="#GENERAL" data-toggle="tab">Cập nhật hạng vé</a></li>
        ...
        <div class="tab-content">
              ...
              <div class="col-md-4">
                <div class="form-group ">
                  ...
                  <select data-placeholder="Select" name="airline_code" class="form-control" tabindex="2">
                      <option value="VN" <?php if(@$pdata[0]->ticket_airline_code == "VN"){ echo "selected";} ?> >Vietnam Airlines</option>
                      <option value="BL" <?php if(@$pdata[0]->ticket_airline_code == "BL"){ echo "selected";} ?>>Jetstar Pacific</option>
                      <option value="VJ" <?php if(@$pdata[0]->ticket_airline_code == "VJ"){ echo "selected";} ?>>Vietjet Air</option>
                  </select>
                </div>
                <div class="form-group ">
                  <label class="required">Hạng vé</label>
                  <input class="form-control posttitle" type="text" placeholder="Hạng vé" name="ticket_level_code" value="<?php echo  @$pdata[0]->ticket_level_code;?>">
                </div>
              </div>
              <div class="col-md-12">
                <?php $this->ckeditor->editor('desc', @$pdata[0]->ticket_level_desc, $ckconfig,'desc'); ?>
              </div>
            </div>
          ...
          <div class="tab-pane wow fadeIn animated in" id="TRANSLATE">
            <?php foreach($languages as $lang => $val){
              if($lang != "vi"){
                @$trans = getTicketLevelTranslation($lang, $pdata[0]->ticket_level_id);  ?>
            <div class="panel panel-default">
