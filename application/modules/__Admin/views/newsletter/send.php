            ...
            <div class="panel-body">
                ...
                <fieldset>
                  <div class="form-group">
                    ...
                    <div class="col-md-5">
                      <input class="form-control" type="text" placeholder="Chủ đề" name="subject">
                    </div>

                    <div class="col-md-2">
          <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-envelope"></i> Gửi</button>
                    </div>
