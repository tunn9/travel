<div class="panel panel-default">
  <div class="panel-heading"><?php echo $header_title; ?></div>
   ...
   <div class="add_button_modal" > <button type="button" data-toggle="modal" data-target="#ADD_BLOG_CAT" class="btn btn-success"><i class="glyphicon glyphicon-plus-sign"></i><?php echo trans('020');?></button></div>
     <?php echo $content; ?>
   </div>
 </div>
  ...
  <div class="modal-dialog">
    ...
    <form action="" method="POST">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo trans('0165');?></h4>
      </div>
      <div class="modal-body form-horizontal">

      <div class="row form-group">
<label  class="col-md-3 control-label text-left"><?php echo trans('0164');?></label>
<div class="col-md-8">
...
<?php foreach($languages as $lang => $val){ if($lang != "vi"){  ?>
<div class="row form-group">
<label  class="col-md-3 control-label text-left"><?php echo trans('0113');?><img src="<?php echo PT_LANGUAGE_IMAGES.$lang.".png"?>" height="20" alt="" /></label>
<div class="col-md-8">
...
<div class="modal fade" id="cat<?php echo $cat->cat_id;?>" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form action="" method="POST">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?php echo trans('0142');?></h4>
      </div>
      <div class="modal-body form-horizontal">
...
<div class="col-md-8">
<select name="status" class="form-control" id="">
<option value="Yes" <?php makeSelected($cat->cat_status,"Yes"); ?>><?php echo trans('053');?></option>
<option value="No" <?php makeSelected($cat->cat_status,"No"); ?> ><?php echo trans('054');?></option>
</select></div>
</div>

<?php foreach($languages as $lang => $val){ if($lang != "vi"){ @$trans = getBlogCategoriesTranslation($lang,$cat->cat_id); ?>
<div class="row form-group">
<label  class="col-md-3 control-label text-left"> <?php echo trans('0113');?> <img src="<?php echo PT_LANGUAGE_IMAGES.$lang.".png"?>" height="20" alt="" /></label>
<div class="col-md-8">
