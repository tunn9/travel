...
// List all latest posts
		function latest_posts($limit, $orderby = null) {
				$this->db->select('pt_blog.post_id,pt_blog.post_created_at,pt_blog.post_category,pt_blog.post_order,pt_blog.post_title,pt_blog.post_slug,pt_blog.post_desc,pt_blog.post_status,pt_blog_categories.cat_name');
				if ($orderby == "za") {
						$this->db->order_by('pt_blog.post_title', 'desc');
				}
				elseif ($orderby == "az") {
