      ...
      <div class="panel-body">
        <br>
          ...
          <div class="row form-group">
            ...
            <hr>
            <div class="row form-group">
              <label  class="col-md-2 control-label text-left">From City</label>
              <div class="col-md-2">
                <input class="form-control" type="text" placeholder="Default Origin" name="default_origin"  value="<?php echo $travelportConf->get_default_origin(); ?>">
              </div>
              <label  class="col-md-1 control-label text-left">To City</label>
              <div class="col-md-2">
          ...
          <!-- <div class="row form-group">
            ...
            <div class="col-md-2">
              <input class="form-control" type="text" placeholder="" name="minprice"  value="">
            </div>
            <label  class="col-md-2 control-label text-left">Maximum Price</label>
            <div class="col-md-2">
              <input class="form-control" type="text" placeholder="" name="maxprice"  value="">
            </div>
          </div> -->
          <hr>
      </div>
...
<script>
  $("form[name='configuration']").on("submit", function(e) {
      ...
      var update_configuration_endpoint = base_url + "admin/travelport_flight/ajaxController/update_configuration";
