  ...
  <form action="" method="POST">
    ...
    <div class="panel-heading">
      <span class="panel-title pull-left">Hotels Combined Settings</span>
            ...
            <div class="panel-body">
             ...
             <div class="form-horizontal  col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                      ...
                      <td>Input your Hotels Combined Affiliate ID here</td>
                      </tr>
                      ...
                      <td>Input your Hotels Combined Brand ID here</td>
                      </tr>

                      <tr>
                       <td>Search ID Number</td>
                      <td>
                      <input type="" class="form-control" name="searchid" placeholder="Search ID Number" value="<?php echo $settings->searchBoxID;?>" />
                      </td>
                      <td>Input your Hotels Combined Search ID Number here</td>
                      </tr>
