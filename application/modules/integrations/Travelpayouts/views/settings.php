...
<span class="panel-title pull-left">Travelpayouts Settings</span>
...
<tr>
<td>Search Widget URL</td>
<td>
<input type="text" class="form-control" name="WidgetURL" placeholder="Widget URL" value="<?php echo $settings->WidgetURL;?>" />
</td>
<td>Input your Search Widget URL</td>
</tr>
<tr>
...
<input type="hidden" name="updatefor" value="travelpayouts" />
