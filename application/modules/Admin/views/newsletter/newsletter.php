...
<div class="<?php echo body;?>">
  <div class="panel panel-primary table-bg">
    <div class="panel-heading">
      <span class="panel-title pull-left"><i class="fa fa-envelope"></i> Quản lý bản tin</span>
      <div class="pull-right">
        <button data-toggle="modal" href="#SendNewsletter" class="btn btn-xs btn-success"><i class="fa fa-envelope-o"></i> Gửi</button>
