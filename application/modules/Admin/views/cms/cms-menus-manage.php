...
<script type="text/javascript">
  ...
  $.alert.open('confirm', 'Bạn có chắc chắn muốn Loại bỏ?', function(answer) {
    if (answer == 'yes'){
...
<div class="panel panel-default">
  <nav class="panel-heading navbar navbar-default" role="navigation" style="margin-bottom:0px">
    <div class="container-fluid">
      <?php if(!empty($menus)){ ?>
      <div class="navbar-header">
        <a class="navbar-brand">Cài đặt Menu</a>
      </div>
      <form class="navbar-form navbar-left" method="POST" action="" role="search">
        <div class="form-group">
          <select type="text" name="menu" class="form-control" id="dbase" placeholder="Search">
        ...
        <button type="submit" class="btn btn-primary"><?php echo trans('0133');?></button>
      </form>
      <?php } ?>
      <div style="margin-right: -26px" class="navbar-form navbar-right" method="POST" action="" role="search">
        <button data-toggle="modal" href="#menu"  class="btn btn-success pull-right"> <?php echo trans('0153');?></button>
      </div>
      <div class="navbar-header">
        <a class="navbar-brand">Menu ID : <?php echo $menudetail[0]->menu_id;?> </a>
      </div>
      <div class="navbar-form navbar-left"  style="padding-right: 6px;">
        <input type="hidden" name="selectmenu" value="1" />
        <button data-toggle="modal" href="#updatemenu<?php echo $menudetail[0]->menu_id;?>" class="btn btn-warning" ><?php echo trans('0142');?></button>
      </div>
      <!--</form> -->
      <?php if($menudetail[0]->coltype == "header"){ }else{ ?>
      <form class="navbar-form navbar-left" style="padding-left: 0px;" >
        <span class="btn btn-danger pull-right delmenu" id="<?php echo $menudetail[0]->menu_id;?>"><?php echo trans('0137');?></span>
      </form>
      <?php } ?>
    </div>
  </nav>
      ...
      <div class="col-md-4">
        <div class="panel panel-default">
          <nav class="navbar navbar-default" role="navigation">
            <div class="container-fluid">
              <div class="navbar-header">
                <a class="navbar-brand"><?php echo trans('015');?></a>
              </div>
            </div>
          </nav>
          <form action="" method="POST">
            ...
            <div class="panel-footer">
              <button type="submit" class="btn btn-primary"><?php echo trans('0154');?></button>
            </div>
          </form>
        </div>
      </div>
              ...
              <div class="dd" id="nestable">
                <ul class="dd-list">
                  ...
                  <li id="listorder_<?php echo $parentpage[0]->page_id; ?>" class="dd-item" data-id="<?php echo $parentpage[0]->page_id; ?>">
                    ...
                    <span id="<?php echo $parentpage[0]->page_id; ?>" style="z-index:99999;margin-top:-44px;margin-right:-42px;" class="btn btn-danger removemenu pull-right"><i class="fa fa-times"></i></span>  <?php } ?>
                    <?php
                      if(!empty($m->children)){ ?>
                    <ul class="dd-list">
                      <?php 
                      ...
                      <li id="listorder_<?php echo $childpage[0]->page_id; ?>" class="dd-item" data-id="<?php echo $childpage[0]->page_id; ?>">
                        ...
                        <ul class="dd-list">
                          ...
                          <li id="listorder_<?php echo $childpage[0]->page_id; ?>" class="dd-item" data-id="<?php echo $childpage[0]->page_id; ?>">
                            ...
                            <?php if($childpage[0]->content_special != 1){ ?>
                            <span id="<?php echo $childpage[0]->page_id; ?>" style="z-index:99999;margin-top:-30px;margin-right:-28px;" class="btn btn-danger btn-xs pull-right removemenu"> <i class="fa fa-times"></i></span> <?php } ?>
                          </li>
                          <?php } } ?>
                        </ul>
                        <!------end grandchild------>
    ...
    <form action="" method="POST">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><?php echo trans('0153');?></h4>
        </div>
        <div class="modal-body">
          <div class="form-horizontal">
            <div class="form-group">
              <label class="col-md-4 control-label"><?php echo trans('0152');?></label>
              <div class="col-md-8">
                <input class="form-control" type="text" placeholder="<?php echo trans('0152');?>" name="menutitle" value="" required>
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-4 control-label"><?php echo trans('099');?></label>
              <div class="col-md-8">
                <select type="text" name="status" class="form-control" placeholder="<?php echo trans('0228');?>">
                  <option value="1" ><?php echo trans('0143');?></option>
                  <option value="0" ><?php echo trans('0144');?></option>
                </select>
              </div>
            </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary"><?php echo trans('037');?></button>
        </div>
      </div>
    </form>
  </div>
...
<!-- Modal Ending-->
<!-- Update menu translation Starting-->
<?php foreach($menus as $m){ ?>
        ...
        <div class="modal-body">
          <div class="form-horizontal">
            <div class="form-group">
              <label class="col-md-4 control-label"><?php echo trans('0152');?></label>
              <div class="col-md-8">
                <input class="form-control" type="text" placeholder="<?php echo trans('0152');?>" name="menutitle" value="<?php echo $m->menu_title;?>" required>
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-4 control-label"><?php echo trans('099');?></label>
              <div class="col-md-8">
                <select type="text" name="status" class="form-control" placeholder="Search">
                  <option value="1" <?php if($m->status == "1"){ echo "selected"; } ?> ><?php echo trans('0143');?></option>
                  <option value="0" <?php if($m->status == "0"){ echo "selected"; } ?> ><?php echo trans('0144');?></option>
                </select>
              </div>
            </div>
...
<?php } ?>
<!-- Update menu translation Modal Ending-->
