...
<style>
    ...
    .login-panel {
        background: url(<?php echo base_url();?>assets/img/login.jpg) no-repeat center center / cover !important;
        height: 100%
    }
...
<div style="position: fixed; width: 500px; height: 200px; margin: 10% auto; /* Will not center vertically and won't work in IE6/7. */ left: 0; right: 0;">
    <img data-wow-duration="0.5s" data-wow-delay="0.5s" src="<?php echo base_url(); ?>assets/img/admin.png"
         class="wow fadeIn center-block" style="width:78px;height:60px;margin-bottom:20px" alt=""/>
    <form method="POST" data-wow-duration="1s" data-wow-delay="1s"
          class="form-signin form-horizontal wow fadeIn animated" role="form" onsubmit="return false;">
        <div>
            <h2 class="form-heading text-center"
                style="text-transform: uppercase; letter-spacing: 5px; margin-top: 0px;">Login Panel</h2>
        ...
        <button data-wow-duration="2s" data-wow-delay="s" type="submit"
                class="btn btn-primary btn-block ladda-button fadeIn animated" data-style="zoom-in">Login
        </button>
        <div style="margin-top:10px" class="resultlogin"></div>
    </form>
    <form role="form" class="logpanel form-forgot form-horizontal wow flipInY animated" style="display: none"
          id="passresetfrm" onsubmit="return false;">
        ...
        <div class="form-actions">
            ...
            <button id="btn-forgot" type="button" class="btn btn-success pull-right resetbtn ladda-button">Reset My
                Password
            </button>
        </div>
    </form>
    <footer data-wow-duration="0.5s" data-wow-delay="0.5s" class="text-center wow fadeIn">
        <small><p data-wow-duration="1s" data-wow-delay="1s" class="text-center wow fadeInDown"
                  style="color:#919191;margin-bottom: 0px; text-transform: uppercase; letter-spacing: 2px;"> Powered by
                UBUK</p></small>
    </footer>
</div>
