		...
		public function index() 
		{
			...
			// {
				if ($this->validadmin()) 
				{
						...
						$travelport_flight = $this->ptmodules->is_main_module_enabled('travelport_flight');
						...
						// fake data
						$modules->graphModules[] = (object)array("name" => "Flights", "data" => $this->data['graphReportHotels']['amounts']);
                        // fake data
