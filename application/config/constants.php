...
defined('EXIT__AUTO_MAX')      OR define('EXIT__AUTO_MAX', 125); // highest automatically-assigned error code
 ...
 /*******My constants*******/
    ...
    define('PT_VERSION', 'v6.3');
    define('PT_LINK', 'http://phptravels.com');
    define('PT_SHOW', '1');
    define('PT_STARS_ICON', "<i class='star star icon-star-5'></i>");
    define('PT_EMPTY_STARS_ICON', "<i class='star star icon-star-empty-2'></i>");
...
define('LOAD_BG','<div class="loadbg"><div id="loading" ><span>Please Wait Loading...</span><br><div id="rotatingDiv"></div></div></div>');
